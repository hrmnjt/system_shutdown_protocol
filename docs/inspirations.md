...
- [Ready.gov — Financial Preparedness](https://www.ready.gov/financial-preparedness)  
  Links to the Emergency Financial First Aid Kit and practical approaches to organizing financial, household, medical, and insurance records.

## Digital legacy and secure access

- [Apple Support — How to add a Legacy Contact](https://support.apple.com/en-us/102631)  
  Product-specific guidance for Apple account access after death.
- [Google Account Help — About Inactive Account Manager](https://support.google.com/accounts/answer/3036546)  
  A model for deciding what data should be shared and with whom after prolonged inactivity.
- [Bitwarden — About Emergency Access](https://bitwarden.com/help/emergency-access/)  
  An example of delegated vault access with trusted contacts, access types, and a waiting period.

Provider features and procedures change. The protocol should describe the intended outcome and point to a tested access method rather than copy time-sensitive provider steps.
...
- [GOV.UK Design System — Task list](https://design-system.service.gov.uk/components/task-list/)  
  Inspiration for showing sequence, status, and incomplete work without hiding it.
- [GOV.UK Design System — Colour](https://design-system.service.gov.uk/styles/colour/)  
  Guidance on contrast, meaning, and never relying on colour alone.
